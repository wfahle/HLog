...
public class GlobalDxccList {
	...
	public static Entity[] get_list() {
		if (list == null) 
		{
		Entity[] ret = { // TODO: finish H-Z (numbers are done)
    ...
    new Entity(   5, "ALAND ISLAND", 0, -1, "^OH0[^M]", EU, "18", "15", R.drawable.ax ),
    new Entity(   6, "ALASKA", 0, -1, "^[AKNW]L([0-8]|9[^K])", NA, "1,2", "01", R.drawable.use ),
    ...
    new Entity(  13, "ANTARCTICA", 0, -1, "^KC4AAA|^RI1ANC|^RI1ANT|^RI20ANT|^VK0|^LU[0-9]X", AN, "(B)", "(C)", R.drawable.aq),
    ...
    new Entity(  17, "AVES ISLAND", 0, -1, "^YV0", NA, "11", "08", R.drawable.ve ),
    ...
    new Entity(  70, "CUBA", 0, -1, "^C[LMO]", NA, "11", "08", R.drawable.cu ),
    ...
    new Entity(  88, "PANAMA", 0, -1, "^HO|^HP|^3[EF]", NA, "11", "07", R.drawable.pa ),
    ...
    new Entity( 105, "GUANTANAMO BAY", 0, -1, "^KG4ZOI|^KG4MOZ|^KG4ZD|^KG4TO|^KG4OX|^KG4XE|^KG4QW|^KG4AN|^KG4/", NA, "11", "08", R.drawable.use ),
    ...
    new Entity( 110, "HAWAII", 0, -1, "^[AKNW]H6|^[AKNW]H7[^K]", OC, "61", "31", R.drawable.use ),
    ...
    new Entity( 116, "COLOMBIA", 0, -1, "^[H5][JK]", SA, "12", "09", R.drawable.co ),
    ...
    new Entity( 148, "VENEZUELA", 0, -1, "^Y[V-Y][^0]|^4M", SA, "12", "09", R.drawable.ve ),
    ...
    new Entity( 153, "MACQUARIE ISLAND", 0, -1, "^VK0M|^VK0TH|^VK0KEV", OC, "60", "30", R.drawable.au ),
    ...
    new Entity( 166, "MARIANA ISLAND", 0, -1, "^[AKNW]HO", OC, "64", "27", R.drawable.mp ),
    ...
    new Entity( 189, "NORFOLK ISLAND", 0, -1, "^VK9[N0]", OC, "60", "32", R.drawable.nf ),
    ...
    new Entity( 206, "AUSTRIA", 0, -1, "^OE|^4Y", EU, "28", "15", R.drawable.at ),
    ...
    new Entity( 215, "CYPRUS", 0, -1, "^5B|^C4|^H2|^P3", AS, "39", "20", R.drawable.cy ),
    new Entity( 216, "SAN ANDREAS & PROVIDENCIA", 0, -1, "^HKO", NA, "11", "09", R.drawable.co ),
    new Entity( 217, "SAN FELIX", 0, -1, "^C[A-E]0X|^3G0X|^X[QR]0X", SA, "14", "12", R.drawable.cl ),
    ...
    new Entity( 221, "DENMARK", 0, -1, "^O[U-Z]|^5[PQ]|^XP", EU, "18", "14", R.drawable.dk ),
    new Entity( 222, "FAROE ISLAND", 0, -1, "^OY", EU, "18", "14", R.drawable.fo ), 
    new Entity( 223, "ENGLAND", 0, -1, "^[GM2][^CDHIJMNPSTUW]", EU, "27", "14", R.drawable.gb ),
    ...
    new Entity( 233, "GIBRALTAR", 0, -1, "^ZB", EU, "37", "14", R.drawable.gi ),
    new Entity( 234, "SOUTHERN COOK ISLAND", 0, -1, "^ZK1|^E5", OC, "62", "32", R.drawable.ck ), 
    ...
    new Entity( 241, "SOUTH SHETLAND ISLANDS", 0, -1, "^4K1|^CE9", SA, "73", "13", R.drawable.aq ), 
    ...
    new Entity( 247, "SPRATLY ISLAND", 0, -1, "^9M4SLL|^1S", AS, "50", "26", R.drawable.my ),
    ...
    new Entity( 266, "NORWAY", 0, -1, "^L[A-N]|^3Y", EU, "18", "14", R.drawable.no ),
    ...
    new Entity( 281, "SPAIN", 0, -1, "^E[A-H][^689]|^A[M-O]", EU, "37", "14", R.drawable.es ), 
    ...
    new Entity( 321, "HONG KONG", 0, -1, "^VR", AS, "44", "24", R.drawable.hk ),
    ...
    new Entity( 466, "SUDAN", 0, -1, "^S[ST]|^6[TU]", AF, "48", "34", R.drawable.sd ),
    ...
    new Entity( 478, "EGYPT", 0, -1, "^S[US]|^6[AB]", AF, "38", "34", R.drawable.eg ),
